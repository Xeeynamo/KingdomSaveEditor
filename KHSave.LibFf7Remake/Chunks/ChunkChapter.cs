...
namespace KHSave.LibFf7Remake.Chunks
{
    public class ChunkChapter
    {
        ...
        private const int MaxObject1Count = 0x800;
        private const int MaxObject2Count = 0x100;
        private const int MaxObject3Count = 0x400;
        ...
        [Data(0xCBD8, Count = MaxObject1Count, Stride = 0x20)] public ChapterObject[] Objects { get; set; }
        [Data(0x2abd8, Count = MaxObject2Count, Stride = 0x20)] public ChapterObject[] Objects2 { get; set; }
        [Data(0x2cbd8, Count = MaxObject3Count, Stride = 0x20)] public ChapterObject[] Objects3 { get; set; }
        ...
        public ChunkChapter()
        {
            ...
            Objects = Enumerable.Range(0, MaxObject1Count).Select(x => new ChapterObject()).ToArray();
            Objects2 = Enumerable.Range(0, MaxObject2Count).Select(x => new ChapterObject()).ToArray();
            Objects3 = Enumerable.Range(0, MaxObject3Count).Select(x => new ChapterObject()).ToArray();
        }
    }
}
