...
namespace KHSave.LibPersona5.Types
{
    ...
    public enum Skill : short
    {
        ...
        [AutoSkill("Auto-Mataru")] AutoMataru, // sono troppi X_X

        [AutoSkill("Sharp Student")] SharpStudent = 855,
        [AutoSkill("Null Elec")] NullElec = 886,
        [AutoSkill("Resist Bless")] ResistBless = 890,
        [AutoSkill("Null Fear")] NullFear = 932,
        [AutoSkill("Freeze Boost")] FreezeBoost = 941,
        [AutoSkill("Touch n' Go")] TouchnGo = 949,
        [AutoSkill("Trigger Happy")] TriggerHappy = 955,
        [AutoSkill("Bless Boost")] BlessBoost = 978,
        [AutoSkill("Soul Chain")] SoulChain = 989,
    }
}
