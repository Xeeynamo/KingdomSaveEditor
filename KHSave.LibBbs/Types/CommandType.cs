...
namespace KHSave.LibBbs.Types
{
    public enum CommandType : ushort
    {
        ...
        [KHSave.LibBbs.Attributes.Shotlock("Shotlock")] Shotlock = 0x011B,
        [KHSave.LibBbs.Attributes.Shotlock("Meteor Shower")] MeteorShower = 0x011C,
        [KHSave.LibBbs.Attributes.Shotlock("Flame Salvo")] FlameSalvo = 0x011D,
        [KHSave.LibBbs.Attributes.Shotlock("Chaos Snake")] ChaosSnake = 0x011E,
        [KHSave.LibBbs.Attributes.Shotlock("Bubble Blaster")] BubbleBlaster = 0x011F,
        [KHSave.LibBbs.Attributes.Shotlock("Dark Volley")] DarkVolley = 0x0120,
        [KHSave.LibBbs.Attributes.Shotlock("Ragnarok")] Ragnarok = 0x0121,
        [KHSave.LibBbs.Attributes.Shotlock("Thunderstorm")] Thunderstorm = 0x0122,
        [KHSave.LibBbs.Attributes.Shotlock("Bio Barrage")] BioBarrage = 0x0123,
        [KHSave.LibBbs.Attributes.Shotlock("Prism Rain")] PrismRain = 0x0124,
        [KHSave.LibBbs.Attributes.Shotlock("Pulse Bomb")] PulseBomb = 0x0125,
        [KHSave.LibBbs.Attributes.Shotlock("Photon Charge")] PhotonCharge = 0x0126,
        [KHSave.LibBbs.Attributes.Shotlock("Absolute Zero")] AbsoluteZero = 0x0127,
        [KHSave.LibBbs.Attributes.Shotlock("Lightning Ray")] LightningRay = 0x0128,
        [KHSave.LibBbs.Attributes.Shotlock("Sonic Shadow")] SonicShadow = 0x0129,
        [KHSave.LibBbs.Attributes.Shotlock("Dark Link")] DarkLink = 0x012A,
        [KHSave.LibBbs.Attributes.Shotlock("Ultima Cannon")] UltimaCannon = 0x012B,
        [KHSave.LibBbs.Attributes.Shotlock("Lightbloom")] Lightbloom = 0x012C,
        [KHSave.LibBbs.Attributes.Shotlock("Multivortex")] Multivortex = 0x012D,
