...
namespace KHSave.SaveEditor.Kh2
{
    public static partial class Data
    {
        public static RoomModel[] Rooms = new RoomModel[]
        {
            ...
            new RoomModel(WorldType.DisneyCastle, 6, GameType.All, "Gummi Hangar"),
            ...
            new RoomModel(WorldType.HollowBastion, 21, GameType.All, "Cavern of Remembrance: Depths"),
            new RoomModel(WorldType.HollowBastion, 22, GameType.All, "Cavern of Remembrance: Mining Area"),
            new RoomModel(WorldType.HollowBastion, 23, GameType.All, "Cavern of Remembrance: Engine Chamber"),
            new RoomModel(WorldType.HollowBastion, 24, GameType.All, "Cavern of Remembrance: Mineshaft"),
            new RoomModel(WorldType.HollowBastion, 25, GameType.All, "Transport to Remembrance"),
            new RoomModel(WorldType.HollowBastion, 26, GameType.All, "Garden of Assemblage"),
            new RoomModel(WorldType.HollowBastion, 27, GameType.All, "Underground Facility"),
            new RoomModel(WorldType.HollowBastion, 28, GameType.All, "Memory's Contortion"),
            new RoomModel(WorldType.HollowBastion, 29, GameType.All, "The World of Nothing"),
            new RoomModel(WorldType.HollowBastion, 30, GameType.All, "Hall of Empty Melodies"),
            new RoomModel(WorldType.HollowBastion, 31, GameType.All, "Bridgeₓₓₓₓₓₓₓ"),
            new RoomModel(WorldType.HollowBastion, 32, GameType.All, "The Old Mansion"),
            new RoomModel(WorldType.HollowBastion, 33, GameType.All, "Station of Remembrance"),
            new RoomModel(WorldType.HollowBastion, 34, GameType.All, "Destiny Island"),
            new RoomModel(WorldType.HollowBastion, 35, GameType.All, "Addled Impasse"),
            new RoomModel(WorldType.HollowBastion, 36, GameType.All, "Mansion: Basement Hall"),
            new RoomModel(WorldType.HollowBastion, 37, GameType.All, "Havoc's Divide"),
            new RoomModel(WorldType.HollowBastion, 38, GameType.All, "Station of Oblivion"),
            new RoomModel(WorldType.HollowBastion, 39, GameType.All, "Station of Awakening"),
            new RoomModel(WorldType.HollowBastion, 40, GameType.All, "Gathering Place"),
            ...
            new RoomModel(WorldType.LandOfDragons, 13, GameType.All, "Palace Gate"),
            ...
            new RoomModel(WorldType.WorldZZ, 0, GameType.All, "いつものばしょ"),
            new RoomModel(WorldType.WorldZZ, 1, GameType.All, "ロビ–"),
            new RoomModel(WorldType.WorldZZ, 2, GameType.All, "しょうじょのへや"),
            new RoomModel(WorldType.WorldZZ, 3, GameType.All, "ちかおおひろま"),
            new RoomModel(WorldType.WorldZZ, 4, GameType.All, "コンピュ–タル–ム"),
            new RoomModel(WorldType.WorldZZ, 5, GameType.All, "カプセルル–ム"),
            new RoomModel(WorldType.WorldZZ, 6, GameType.All, "メインカプセル"),
            new RoomModel(WorldType.WorldZZ, 7, GameType.All, "かいがん"),
            new RoomModel(WorldType.WorldZZ, 8, GameType.All, "ロクサスのへや"),
            new RoomModel(WorldType.WorldZZ, 9, GameType.All, "ディスティニ–アイランド"),
            new RoomModel(WorldType.WorldZZ, 10, GameType.All, "メインストリ–ト"),
            new RoomModel(WorldType.WorldZZ, 11, GameType.All, "さんばし"),
            new RoomModel(WorldType.WorldZZ, 12, GameType.All, "トロン"),
            new RoomModel(WorldType.WorldZZ, 13, GameType.All, "トイ·スト–リ–"),
            new RoomModel(WorldType.WorldZZ, 14, GameType.All, "モンスタ–ズ·インク"),
            new RoomModel(WorldType.WorldZZ, 15, GameType.All, "あきち"),
            new RoomModel(WorldType.WorldZZ, 16, GameType.All, "たいかいかいじょう"),
            new RoomModel(WorldType.WorldZZ, 17, GameType.All, "ろじうら"),
            new RoomModel(WorldType.WorldZZ, 18, GameType.All, "やしきへのみち"),
            new RoomModel(WorldType.WorldZZ, 19, GameType.All, "もんぜん"),
            new RoomModel(WorldType.WorldZZ, 20, GameType.All, "ダイニングル–ム"),
            new RoomModel(WorldType.WorldZZ, 21, GameType.All, "DIVETOHEART"),
            new RoomModel(WorldType.WorldZZ, 22, GameType.All, "メインえき"),
            new RoomModel(WorldType.WorldZZ, 23, GameType.All, "ホロウバスティオン1"),
            new RoomModel(WorldType.WorldZZ, 24, GameType.All, "テストマップ(リアルタイム1)"),
            new RoomModel(WorldType.WorldZZ, 25, GameType.All, "GBA1"),
            new RoomModel(WorldType.WorldZZ, 26, GameType.All, "GBA2"),
            new RoomModel(WorldType.WorldZZ, 27, GameType.All, "いちばんがい"),
            new RoomModel(WorldType.WorldZZ, 28, GameType.All, "ホロウバスティオン2"),
            new RoomModel(WorldType.WorldZZ, 29, GameType.All, "テストマップ(ライオンキング)"),
            new RoomModel(WorldType.WorldZZ, 30, GameType.All, "テストマップ(ム–ラン)"),
            new RoomModel(WorldType.WorldZZ, 31, GameType.All, "GBA3"),
            new RoomModel(WorldType.WorldZZ, 32, GameType.All, "テストマップ(コリジョン)"),
            new RoomModel(WorldType.WorldZZ, 33, GameType.All, "テストマップ(エントランス)"),
            new RoomModel(WorldType.WorldZZ, 34, GameType.All, "テストマップ(アトリビュ–ト)"),
            new RoomModel(WorldType.WorldZZ, 35, GameType.All, "テストマップ(カリブ)"),
            new RoomModel(WorldType.WorldZZ, 36, GameType.All, "テストマップ"),
            new RoomModel(WorldType.WorldZZ, 37, GameType.All, "キャラチェック"),
            new RoomModel(WorldType.WorldZZ, 38, GameType.All, "サウンドチェック"),
            new RoomModel(WorldType.WorldZZ, 39, GameType.All, "テストマップ(カベ)"),
            new RoomModel(WorldType.WorldZZ, 40, GameType.All, "FM(1)"),
            new RoomModel(WorldType.WorldZZ, 41, GameType.All, "FM(2)"),
            new RoomModel(WorldType.WorldZZ, 42, GameType.All, "FM(3)"),
            new RoomModel(WorldType.WorldZZ, 43, GameType.All, "FM(4)"),
            new RoomModel(WorldType.WorldZZ, 44, GameType.All, "FM(5)"),
            new RoomModel(WorldType.WorldZZ, 45, GameType.All, "FM(6)"),
            new RoomModel(WorldType.WorldZZ, 46, GameType.All, "コックピット"),
            new RoomModel(WorldType.WorldZZ, 47, GameType.All, "FM(7)"),
            new RoomModel(WorldType.WorldZZ, 48, GameType.All, "FM(8)"),
            new RoomModel(WorldType.WorldZZ, 49, GameType.All, "FM(9)"),
            new RoomModel(WorldType.WorldZZ, 50, GameType.All, "COM(1)"),
            new RoomModel(WorldType.WorldZZ, 51, GameType.All, "COM(2)"),
            new RoomModel(WorldType.WorldZZ, 52, GameType.All, "COM(3)"),
            new RoomModel(WorldType.WorldZZ, 53, GameType.All, "COM(4)"),
            new RoomModel(WorldType.WorldZZ, 54, GameType.All, "COM(5)"),
            new RoomModel(WorldType.WorldZZ, 55, GameType.All, "COM(6)"),
            new RoomModel(WorldType.WorldZZ, 56, GameType.All, "COM(7)"),
            new RoomModel(WorldType.WorldZZ, 57, GameType.All, "COM(8)"),
            new RoomModel(WorldType.WorldZZ, 58, GameType.All, "COM(9)"),
            new RoomModel(WorldType.WorldZZ, 59, GameType.All, "COM(10)"),
            new RoomModel(WorldType.WorldZZ, 60, GameType.All, "COM(11)"),
            new RoomModel(WorldType.WorldZZ, 61, GameType.All, "COM(12)"),
            new RoomModel(WorldType.WorldZZ, 62, GameType.All, "COM(13)"),
            new RoomModel(WorldType.WorldZZ, 63, GameType.All, "COM(14)"),
        };
