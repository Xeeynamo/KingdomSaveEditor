...
namespace KHSave.Lib3.Presets
{
    public static partial class Presets
    {
        ...
        public static readonly Dictionary<string, Map> MAPS = new Dictionary<string, Map>
        {
            ...
            ["/Game/Maps/yt/umap/yt_50/yt_50_room"] = new Map { Name = "Yen Sid Tower - Room" },
            ...
            ["/Game/Levels/rg/rg_50/rg_50"] = new Map { Name = "" },
            ["/Game/Levels/rg/rg_51/rg_51"] = new Map { Name = "" },
            ...
            ["/Game/Levels/gm/gm_50/gm"] = new Map { Name = "Cutscene" },
